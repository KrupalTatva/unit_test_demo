package com.example.unittestdemo.fragment;
...
public class Blank1Fragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        btnGoToFragment2 = view.findViewById(R.id.btnGoToFragment2);
        btnGoToFragment2.setOnClickListener(v->{
            Navigation.findNavController(v).navigate(Blank1FragmentDirections.actionBlank1FragmentToBlank2Fragment());
        });
